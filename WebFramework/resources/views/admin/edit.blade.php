            ...
            <div class="col-lg-12">
              <section class="panel">
                <header class="panel-heading">
                  Mengedit Data Pengalaman Kerja
                </header>
                
                <div class="panel-body">
                  <div class="form">
                      <form class="form-validate form-horizontal" id="pengalaman_kerja" method="POST" action="{{route('pengalaman_kerja.update',$pengalaman_kerja->id)}}">
                        @csrf
                            @method('put')
                          ...
                          <div class="col-lg-10">
                            <input class="form-control @error('nama')
                                is-invalid
                            @enderror" id="nama" name="nama" type="text" required placeholder="Nama Lengkap" value="{{$pengalaman_kerja->nama}}"/>
                          @error('nama')
                        ...
                        <div class="form-group ">
                          ...
                          <div class="col-lg-10">
                            <input class="form-control @error('jabatan') 
                                is-invalid
                            @enderror" id="jabatan" type="text" name="jabatan" required placeholder="Jabatan" value="{{$pengalaman_kerja->jabatan}}"/>
                          @error('jabatan')
                        ...
                        <div class="form-group ">
                          ...
                          <div class="col-lg-10">
                            <input class="form-control @error('tahun_masuk')
                                is-invalid
                            @enderror " id="tahun_masuk" type="text" name="tahun_masuk" required placeholder="Tahun Masuk" value="{{$pengalaman_kerja->tahun_masuk}}"/>
                            @error('tahun_masuk')
                            <div class="invalid-feedback">{{$message}}</div>                           
                            @enderror
                          </div>
                        ...
                        <div class="form-group ">
                          ...
                          <div class="col-lg-10">
                            <input class="form-control @error('tahun_keluar')
                                is-invalid
                            @enderror" id="tahun_keluar" name="tahun_keluar" type="text" required placeholder="Tahun Keluar" value="{{$pengalaman_kerja->tahun_keluar}}" />
                              @error('tahun_keluar')
                              <div class="invalid-feedback">{{$message}}</div>
                              @enderror
                          </div>
